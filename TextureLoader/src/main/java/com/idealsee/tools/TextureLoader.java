...
//		}, imageSize, imageSize)).run();
	...
	public static void loadRawImage(byte[] imageData, int imageSize) {
		Log.v(TAG, "Start load Image");

		UnityPlayer.currentActivity.runOnUiThread(new RawImageLoader(imageData, new RawImageLoader.IImageFileLoadFinish() {
